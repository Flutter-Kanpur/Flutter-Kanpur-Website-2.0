...
const SkeletonCard = () => (
  ...
  >
    ...
    >
      ...
      {/* Description lines */}
      <Box
        sx={{ display: "flex", flexDirection: "column", gap: "8px", mt: "4px" }}
      >
      ...
      <Box
        sx={{ display: "flex", alignItems: "center", gap: "20px", mt: "8px" }}
      >
        <Skeleton
          variant="rectangular"
          width="100%"
...
const filterEvents = (events, quickFilter, modalFilters) => {
  ...
  if (modalFilters.timeRange) {
    result = result.filter(
      (e) =>
        e.timeRange?.toLowerCase() === modalFilters.timeRange.toLowerCase(),
    );
  }
